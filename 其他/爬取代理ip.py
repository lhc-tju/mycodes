...
if __name__ == '__main__':
    path = '4cnki.txt' # 存放爬取ip的文档path
    targeturl = 'http://kns.cnki.net/kns/brief/result.aspx?dbprefix=SCDB&crossDbcodes=CJFQ,CDFD,CMFD,CPFD,IPFD,CCND,CCJD' # 验证ip有效性的指定url
